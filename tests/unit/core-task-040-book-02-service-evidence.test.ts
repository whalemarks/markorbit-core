...
describe('CORE-TASK-040 Book 02 Service evidence', () => {
  it('promotes Customer through Classification in dependency order', () => {
  ...
  it('derives 37 / 3 / 52 and leaves global Service acceptance unresolved', () => {
    assert.deepEqual(BOOK_02_MVP_GAP_BASELINE.summary.mustBuildNow, {
      total: 115,
      meets_required_depth: 37,
      partial_evidence: 3,
      validated_skeleton_only: 52,
