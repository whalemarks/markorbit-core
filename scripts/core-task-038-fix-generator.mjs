...
const oldSearch = String.raw`      !['Draft', 'ReviewRequired', 'Active'].includes(\n        String(input.trademarkStatus)\n      )`;
const newSearch = String.raw`      !['Draft', 'ReviewRequired', 'Active'].includes(String(input.trademarkStatus))`;
