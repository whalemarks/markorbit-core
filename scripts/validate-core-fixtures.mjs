...
import { validateCoreCommunicationReviewWorkflowFixture } from '../src/validation/core-communication-review-workflow-fixture-validation.ts';
...
const validators = {
  ...
  core_task_057c_api_boundaries: validateCoreApiBoundaryFixture,
