...
const canonicalServiceSkeleton = (
  ...
  metadata: {
    ...
    ...(serviceType === 'policy-evaluation-service'
      ? {
          behaviorImplementationTask: 'CORE-TASK-054',
...
export const CORE_SERVICE_CONTRACT_SKELETONS = [
  ...
  canonicalServiceSkeleton(
    ...
    'policy-service.md',
    'Defines the Policy service ownership boundary for contextual rule lifecycle, Permission-aware evaluation, restriction, review, approval, redaction, non-disclosure guidance, safe reference validation, applicable-policy listing, archival and audit trace without granting Permission, executing approval, replacing Workflow or professional judgment, or embedding jurisdiction-specific legal rule engines.',
    [
      'Policy service ownership, contextual rule lifecycle, Permission-aware evaluation, restriction and safe-output guidance, reference validation, applicable-policy listing, archival, and audit trace boundary.'
    ],
    [
      'policy, permission decision, identity, user, organization, AI agent, system actor, action, resource, jurisdiction, confidentiality, workflow state, context, review, approval, audit, and event references'
    ],
    [
      'Policy boundary references, governed safe views, deterministic contextual decisions, review and approval requirements, redaction and non-disclosure guidance, validation results, and Event trace handoff'
    ],
    [
      'Permission grant ownership; authentication; workflow or professional approval execution; professional judgment; jurisdiction-specific legal rule engine; protected condition or resource disclosure; product-specific policy logic; autonomous AI policy override or bypass.'
    ],
    'CORE-TASK-054'
  ),
  serviceSkeleton(
