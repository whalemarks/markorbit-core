...
export const CORE_SERVICE_CONTRACT_SKELETONS = [
  serviceSkeleton(
    ...
    'Skeleton contract boundary for identity resolution service responsibilities.',
    'Establishes a service contract placeholder for identity ownership boundaries without resolving identities in executable form.',
    ['Identity resolution service contract boundary.'],
    ['identity domain references'],
    ['identity boundary references']
  ),
  serviceSkeleton(
