...
export const CORE_FIXTURE_MANIFEST = [
  ...
  {
    id: 'core-task-057c-api-boundaries',
    type: 'core_task_057c_api_boundaries',
    path: 'fixtures/api/core-task-057c-api-boundaries.fixture.json',
    required: true
  },
  {
  ...
  {
    id: 'core-task-058c-communication-review-workflow',
    type: 'core_task_058c_communication_review_workflow',
    path: 'fixtures/workflows/core-task-058c-communication-review-workflow.fixture.json',
    required: true
  },
  {
